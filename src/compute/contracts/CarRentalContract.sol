...
contract CarRentalContract {
  ...
  function storeRentalCar(bytes32 ipfsHash)
    public
  ...
  function authorizeRentalCar(bytes32 ipfsHash, address carRenter)
    public
  ...
  function getRentalCarDetail(bytes32 ipfsHash)
    public
    view
    returns (address, address, bool, bool)
  {
    return (
      rentalCars[ipfsHash].carOwner,
