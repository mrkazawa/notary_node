...
instances.push(constructAutoCannonInstance('Multi Notary #1', notaryOneURL));
instances.push(constructAutoCannonInstance('Multi Notary #2', notaryTwoURL));
instances.push(constructAutoCannonInstance('Multi Notary #3', notaryThreeURL));
instances.push(constructAutoCannonInstance('Multi Notary #4', notaryFourURL));
